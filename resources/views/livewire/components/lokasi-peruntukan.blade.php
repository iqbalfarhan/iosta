    ...
    <div class="modal">
        <form class="modal-box" wire:submit.prevent="simpan">
            ...
            <div class="flex flex-col gap-3 py-6">
                <textarea type="text" wire:model="template" class="textarea bg-base-200 w-full" placeholder="paste dari excel"></textarea>
                <div class="divider text-xs">Input manual</div>
                @if ($template)
                    @php
